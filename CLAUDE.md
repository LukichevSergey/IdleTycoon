...
- **`js/data/`** — content as data: `properties.js` (25 rental objects + tenant name pools), `market.js` (stocks/bonds/crypto), `deposits.js`. Adding an asset = adding one record; UI and logic pick it up automatically.
